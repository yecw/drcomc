...
int login(int sockfd, struct sockaddr_in addr, unsigned char seed[], unsigned char auth_information[]) {
	...
	login_packet[246]=0x64;
    login_packet[247]=0x63;
    login_packet[248]=0x35;
    login_packet[249]=0x65;
    login_packet[250]=0x66;
    login_packet[251]=0x32;
    login_packet[252]=0x30;
    login_packet[253]=0x37;
    login_packet[254]=0x61;
    login_packet[255]=0x62;
    login_packet[256]=0x65;
    login_packet[257]=0x65;
    login_packet[258]=0x65;
    login_packet[259]=0x65;
    login_packet[260]=0x30;
    login_packet[261]=0x33;
    login_packet[262]=0x30;
    login_packet[263]=0x35;
    login_packet[264]=0x36;
    login_packet[265]=0x31;
    login_packet[266]=0x32;
    login_packet[267]=0x38;
    login_packet[268]=0x30;
    login_packet[269]=0x63;
    login_packet[270]=0x61;
    login_packet[271]=0x31;
    login_packet[272]=0x66;
    login_packet[273]=0x31;
    login_packet[274]=0x35;
    login_packet[275]=0x61;    
    login_packet[276]=0x39;
    login_packet[277]=0x62;
    login_packet[278]=0x39;
    login_packet[279]=0x38;
    login_packet[280]=0x30;
    login_packet[281]=0x37;
    login_packet[282]=0x35;
    login_packet[283]=0x63;
    login_packet[284]=0x39;
    login_packet[285]=0x63;
    ...
    login_packet[counter + 16] = 0xe4;
    login_packet[counter + 17] = 0xc7;
